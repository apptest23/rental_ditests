@if ($paginator->hasPages())
   ...
   <div class="dataTables_info new_pagination " id="example2_info" role="status" aria-live="polite"> Showing {{($paginator->currentpage()-1)*$paginator->perpage()+1}} to {{(($paginator->currentpage()-1)*$paginator->perpage())+$paginator->count()}} of {{$paginator->total()}} Product</div>
