  ...
  <div class="head-banner">
      ...
      <div class="sales">
         <div class="box-header padding">
           ...
           <form  action="{{url('admin/store_update_product')}}/{{$id}}" enctype="multipart/form-data" method="POST" >    
           ...
           @csrf 
            ...
            @foreach($product_image as $pi)
             ...
             <div class="gallery_{{$pi->id}} gallery">                       
                 ...
                 <div class=""><a class="btn1 delete-btn1" href="{{url('admin/update_product_image')}}/{{$pi->id}}">Update</a></div>
                 <div class="desc" onclick="delete_product_image({{$pi->id}})"><a class="btn1" >delete</a></div>
                  ...
                  .then((willDelete) => {
                    ...
                    var id = $id;
                          ...
                          $.ajax({
                                ...
                                url:BASE_URL+'/admin/delete_product_image/'+id,
                                type:'GET',
                                dataType: "json",
            ...
            $('select[name="subcategory"]').on('change',function(){
             ...
             if(id){
                ...
                $.ajax({
                     ...
                     url: BASE_URL+'/admin/get_item/'+id,
                     type:'GET',
                     dataType:'json',
                 success:function(data){
