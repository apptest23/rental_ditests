 ...
 <div class="head-banner">
          <ul class="breadcrumb">
              <li>
                ...
                <li>
                  <a href="{{url('admin/update_product')}}/{{$product_id}}"><span>Update Product </span></a>
              </li>
              <li>
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         ...
         <div class="detail table-responsive">
          ...
          <form  action="{{url('admin/store_update_product_image')}}/{{$id}}" enctype="multipart/form-data" method="POST" >
                @csrf
