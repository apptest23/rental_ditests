...
@section('content')
 ...
 <div class="head-banner">
          <ul class="breadcrumb">
              ...
              <li>
                  <a href="{{url('admin/category')}}"><span>Update Category</span></a>
              </li>
          </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         ...
         <div class="detail table-responsive">
          ...
          <form  action="{{url('admin/store_update_category')}}/{{$id}}" enctype="multipart/form-data" method="POST" >
                @csrf
            <div class="details_main">
               ...
               <div class="details_inner">
                  <div class="part2">
                     ...
                     <label>Icon Image</label>
                         ...
                         <div class="details_image">
                          <img id="blah1" src="/uploads/{{$icon_image}}" alt="" />
                        </div>

                         <input type="file" name="icon_image" onchange="readURL1(this);" require="">
                         <input type="hidden" name="oldimage1" value="{{$icon_image}}" require="">
               ...
               <div class="part">
                  ...
                  <div class="col-md-12 data">
                     <input type="text" placeholder="Enter Name" name="name" value="{{$c_name}}">
                 ...
                 <div class="part">
                  ...
                  <div class="col-md-12 data ">
                     ...
                     <textarea name="description" placeholder="please enter full description" autocomplete="off" value="{{$description}}" >{{$description}}</textarea>
