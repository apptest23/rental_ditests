...
<body>
   <header class="page-header">
      <nav class="main-menu">
         <div class="logo">
               <h1><a href="{{url('Partner/vendor_home')}}">rent<span>al</span></a></h1>
         </div>
         <!-- <a href="index.html"class="logo"><img src="image/logo.jpg" alt="img"></a> -->
         <ul class="menu main_drop">
            <li><a href="{{url('Partner/vendor_home')}}"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span> <i class="fal fa-chevron-down"></i></a>
               <ul class="drp-menu">
            ...
            <li><a href="#"><i class="fas fa-file-alt"></i> <span>Product</span> <i class="fal fa-chevron-down"></i></a>
               <ul class="drp-menu">
                  <li><a href="{{url('Partner/vender_product')}}">Product List</a></li>
          ...
          <div class="row">
              <div class="col-lg-6 col-md-6 col-6">
                 <div class="mobile_logo">
                   <a href="{{url('Partner/vendor_home')}}"><img src="image/logo.jpg"></a>
                 </div>
               </div>
               <div class="col-lg-6 col-md-6 col-6">
                    ...
                    <div class="dropdown1">
                      <button id="myBtn1">
                        ...
                        <div id="myDropdown1" class="dropdown-content1">
                          <a href="{{url('Partner/profile')}}">Profile</a>
                          <a href="{{url('Partner/vendor_logout')}}"><i class="fas fa-lock"></i>Logout</a>
                        </div>
                    </div>
                  </div>
                  <div class="mobile-menu">
                     <div id="mySidepanel" class="sidepanel">
                        <div class="m_menu main-menu">
                           ...
                           <ul class="menu main_drop">
                              <li><a href="{{url('Partner/vendor_home')}}"><span>Dashboard</span> <i class="fal fa-chevron-down"></i></a>
                  ...
                  <div class="login">
                    <div class="dropdown1">
                      <button id="myBtn1">
                        ...
                        <div id="myDropdown1" class="dropdown-content1">
                          <a href="{{url('Partner/profile')}}"><i class="fas fa-user"> </i>Profile</a>
                          <a href="{{url('Partner/vendor_logout')}}"><i class="fas fa-lock"></i>Logout</a>
                        </div>
                    </div>
                  </div>
